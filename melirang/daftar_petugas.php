...
try {
    $query = "SELECT * FROM registrasi WHERE role = 'admin' ORDER BY created_at DESC";
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Foto</th>
                        <th>Status</th>
                        <th>Password</th> <!-- Tampilkan password yang di-hash -->
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($petugas as $data) : ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($data['password']); ?></td> <!-- Tampilkan password yang di-hash -->
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
